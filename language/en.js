export default {
    ...
    system: {
        ...
        botAdmin: "Sorry, Milky needs to be an admin to run this command.",
        owner: "Sorry, you don't have permission to run this command.",
        premium: "This feature is exclusive for premium users.",
        wait: "Wait a minute...",
        fail: "An error occurred, process failed.",
        error: "An error occurred, please tell the owner.",
        done: "Command executed.",
        ...
        groupNotRegistered: "This group is not registered. Tell the owner to register this group.",
    ...
    plugins: {
        ...
        setup: {
            ...
            statusOn: "enabled",
            statusOff: "disabled",
            listGroupTitle: "Group List",
            listGroupSection: "Whitelisted Groups",
            secFeatureTitle: "Security Features",
            toggleSection: "Select to toggle",
        ...
        gt: {
            ...
            updateSuccess: "Synchronization successful! Found and added *${args[0]}* new heroes to the database.",
            updateNoChange: "Database is up to date. No new heroes.",
            updateError: "Failed to synchronize: ${args[0]}",
            showFallback: "*${args[0]}* (${args[1]}* ${args[2]})",
            invUnknown: "- #? ID ${args[0]} (unknown)",
            invEmpty: "- No cards -",
            giveInvalidType: "Invalid gacha type. Use 'gt'."
        },
        group: {
    ...
    game: {
        wordle: {
            ...
            webCaption: "*# Wordle ${args[0]}*\nSession: ${args[1]}\n\n> If the website cannot be opened, use Legacy Version to play Wordle here.",
            btnOpen: "Open Minigame",
            btnLegacy: "Legacy Version"
        },
        afk: {
    ...
    tools: {
        autoplay: {
            desc: "Automatically play songs with AI recommendations and sleep timer.",
            usage: "Enter song title or YouTube URL.",
            active: "You already have an active Autoplay session. Use *.cancel* to stop it.",
            timerTitle: "Autoplay Sleep Timer",
            timerText: "Please select how long the bot will play songs before stopping automatically.\n\nTip: Make sure you have enabled Auto Download Media in WhatsApp settings so songs can play smoothly when the screen is off.",
            timerSet: "Sleep timer set to ${args[0]} minutes. Enjoy the music!",
            timerEnd: "Sleep Timer: Time's up! Autoplay session stopped automatically.\n\nTonight's Music History:\n${args[0]}\n\nGood night, sweet dreams!",
            failed: "Failed to download song: ${args[0]}. Skipping to next song...",
            aiError: "Failed to get AI recommendation. Session stopped.",
        ...
        removebg: {
            desc: "Removes an image's background, making it transparent.",
            invalid: "Send or reply to an image with caption *${args[0]}${args[1]}*",
            processing: "*# Remove BG*\n\nProcessing image...",
            success: "*# Remove BG*\n\nBackground removed!",
            failed: "*# Remove BG*\n\nFailed to remove background. Please try again later."
        },
        enhance: {
            desc: "Upscales image resolution and quality using AI.",
            invalid: "Send or reply to an image (JPG/PNG) with caption *${args[0]}${args[1]}*",
            success: "*# HD Enhance*\n\nImage quality successfully enhanced to 2x resolution!",
            failed: "*# HD Enhance*\n\nFailed to enhance the image. Please try again later.",
            tooLarge: "*# HD Enhance*\n\nImage is too large. Maximum 5 MB."
        },
        enhance2: {
            desc: "Upscales image resolution using AI (Upscaler v2).",
            invalid: "Send or reply to an image (JPG/PNG) with caption *${args[0]}${args[1]}*",
            success: "*# HD Enhance v2*\n\nImage enhanced successfully!",
            failed: "*# HD Enhance v2*\n\nFailed to enhance the image. Please try again later.",
            tooLarge: "*# HD Enhance v2*\n\nImage is too large. Maximum 5 MB."
        },
        cookie: {
            desc: "Edit an image with AI (Milky Cookie).",
            invalid: "Send or reply to an image (JPG/PNG) with caption *${args[0]}${args[1]} <instruction>*",
            noText: "Provide an edit instruction. Example: *${args[0]}${args[1]} add a birthday hat*",
            success: "*# Milky Cookie*\n\nImage edited successfully!",
            failed: "*# Milky Cookie*\n\nFailed to edit the image. Please try again later.",
            filtered: "*# Milky Cookie*\n\nHey, sorry! Milky can't create this image for you. Please try a different image or instruction!",
            tooLarge: "*# Milky Cookie*\n\nImage is too large. Maximum 5 MB."
        },
        brat: {
            desc: "Create a brat sticker from text.",
            noText: "Provide some text. Example: *${args[0]}${args[1]} hello world*",
            failed: "*# Brat*\n\nFailed to create brat sticker. Please try again later."
        },
        tomedia: {
            desc: "Convert a sticker to image/video, or a video to audio (MP3).",
            invalid: "Send or reply to a sticker/video with caption *${args[0]}${args[1]}*",
    ...
    rpg: {
        ...
        daily: {
            ...
            rewardSuccess: "*${args[0]}* claimed *${args[1]}* from Daily Reward.${args[2] ? ` *(${args[2]}x Streak)*` : ''}",
            rewardNotify: "*${args[0]}*, you claimed *${args[1]}* from Daily Reward.${args[2] ? ` *(${args[2]}x Streak)*` : ''}",
        ...
        leaderboard: {
            ...
            row: "${args[0]}. @${args[1]}\n  ${args[2]} : ${args[3]}\n\n",
            footer: "\nType *${args[0]}level* to view top level."
        },
        pay: {
        ...
        race: {
            ...
            pathTitle: "*EVOLUTION PATH: ${args[0]}*\n\n",
            pathOrigin: "Origin: ${args[0]}\n",
            pathRow: "${args[0]}-- *${args[1]}* (T${args[2]})\n${args[0]}    Chance: ${args[3]}%\n",
            pathEmpty: "No further evolution paths."
        },
        rein: {
        ...
        whois: {
            ...
            profileTitle: "*# User Profile: ${args[0]}*"
        }
    },
    ...
    misc: {
        ...
        donate: {
            desc: "Support Milky Interactive through a QRIS donation.",
            caption: "*# Donate Us*\n\nClick below to be directed to the QRIS page. Thank you for donating to Milky Interactive!",
            btn: "Open QRIS Page"
        },
        report: {
