export default {
    // Global Messages (Legacy support, but migrating to system)
    mess: {
    ...
    system: {
        ...
        groupNotRegistered: "Grup ini tidak terdaftar. Beritahu owner untuk mendaftarkan grup ini.",
    ...
    plugins: {
        ...
        setup: {
            ...
            statusOn: "diaktifkan",
            statusOff: "dimatikan",
            listGroupTitle: "Daftar Grup",
            listGroupSection: "Grup Whitelist",
            secFeatureTitle: "Fitur Security",
            toggleSection: "Pilih untuk Toggle",
    ...
    game: {
        wordle: {
            ...
            webCaption: "*# Wordle ${args[0]}*\nSession: ${args[1]}\n\n> Jika website tidak dapat dibuka, gunakan Legacy Version untuk bermain wordle disini.",
            btnOpen: "Buka Minigame",
            btnLegacy: "Versi Klasik"
        },
        afk: {
    ...
    tools: {
        autoplay: {
            desc: "Memutar lagu secara otomatis dengan rekomendasi AI dan timer tidur.",
            usage: "Masukkan judul lagu atau URL YouTube.",
            active: "Kamu sudah memiliki sesi Autoplay yang aktif. Gunakan *.cancel* untuk menghentikan.",
            timerTitle: "Autoplay Sleep Timer",
            timerText: "Silakan pilih berapa lama bot akan memutar lagu sebelum berhenti otomatis.\n\nSaran: Pastikan kamu sudah mengaktifkan Unduh Otomatis Media di pengaturan WhatsApp agar lagu dapat terputar lancar saat layar mati.",
            timerSet: "Timer tidur diatur ke ${args[0]} menit. Selamat menikmati musik!",
            timerEnd: "Sleep Timer: Waktu habis! Sesi Autoplay dihentikan secara otomatis.\n\nRiwayat Musik Malam Ini:\n${args[0]}\n\nSelamat tidur, semoga mimpi indah!",
            failed: "Gagal mengunduh lagu: ${args[0]}. Melompat ke lagu selanjutnya...",
            aiError: "Gagal mendapatkan rekomendasi AI. Sesi dihentikan.",
        ...
        removebg: {
            desc: "Menghapus latar belakang gambar menjadi transparan.",
            invalid: "Kirim atau reply gambar dengan caption *${args[0]}${args[1]}*",
            processing: "*# Remove BG*\n\nSedang memproses gambar...",
            success: "*# Remove BG*\n\nLatar belakang berhasil dihapus!",
            failed: "*# Remove BG*\n\nGagal menghapus latar belakang. Coba lagi nanti."
        },
        enhance: {
            desc: "Meningkatkan resolusi dan kualitas gambar menggunakan AI.",
            invalid: "Kirim atau reply gambar (JPG/PNG) dengan caption *${args[0]}${args[1]}*",
            success: "*# HD Enhance*\n\nKualitas gambar berhasil ditingkatkan ke resolusi 2x!",
            failed: "*# HD Enhance*\n\nGagal meningkatkan kualitas gambar. Coba lagi nanti.",
            tooLarge: "*# HD Enhance*\n\nUkuran gambar terlalu besar. Maksimal 5 MB."
        },
        enhance2: {
            desc: "Meningkatkan resolusi gambar dengan AI (Upscaler v2).",
            invalid: "Kirim atau reply gambar (JPG/PNG) dengan caption *${args[0]}${args[1]}*",
            success: "*# HD Enhance v2*\n\nGambar berhasil ditingkatkan!",
            failed: "*# HD Enhance v2*\n\nGagal meningkatkan gambar. Coba lagi nanti.",
            tooLarge: "*# HD Enhance v2*\n\nUkuran gambar terlalu besar. Maksimal 5 MB."
        },
        cookie: {
            desc: "Edit sebuah gambar dengan AI (Milky Cookie).",
            invalid: "Kirim atau reply gambar (JPG/PNG) dengan caption *${args[0]}${args[1]} <instruksi>*",
            noText: "Berikan instruksi edit. Contoh: *${args[0]}${args[1]} tambahkan topi ulang tahun*",
            success: "*# Milky Cookie*\n\nGambar berhasil diedit!",
            failed: "*# Milky Cookie*\n\nGagal mengedit gambar. Coba lagi nanti.",
            filtered: "*# Milky Cookie*\n\nHey, maaf! Milky tidak dapat membuatkan gambar ini untukmu. Tolong coba gambar atau perintah yang lain!",
            tooLarge: "*# Milky Cookie*\n\nUkuran gambar terlalu besar. Maksimal 5 MB."
        },
        brat: {
            desc: "Membuat sticker brat dari teks.",
            noText: "Berikan teks. Contoh: *${args[0]}${args[1]} halo dunia*",
            failed: "*# Brat*\n\nGagal membuat sticker brat. Coba lagi nanti."
        },
        tomedia: {
            desc: "Konversi sticker jadi gambar/video, atau video jadi audio (MP3).",
            invalid: "Kirim atau reply sticker/video dengan caption *${args[0]}${args[1]}*",
            success: "*# To Media*\n\nBerhasil dikonversi!",
            failed: "*# To Media*\n\nGagal mengkonversi. Coba lagi nanti."
        },
        editaudio: {
    ...
    rpg: {
        ach: {
            ...
            has: "Sudah didapatkan",
            notHas: "Belum didapatkan",
        ...
        daily: {
            ...
            rewardSuccess: "*${args[0]}* mengambil *${args[1]}* dari Daily Reward.${args[2] ? ` *(${args[2]}x Streak)*` : ''}",
            rewardNotify: "*${args[0]}*, kamu mengambil *${args[1]}* dari Daily Reward.${args[2] ? ` *(${args[2]}x Streak)*` : ''}",
        ...
        leaderboard: {
            ...
            row: "${args[0]}. @${args[1]}\n  ${args[2]} : ${args[3]}\n\n",
            footer: "\nKetik *${args[0]}level* untuk melihat top level."
        },
        pay: {
        ...
        race: {
            ...
            pathEmpty: "Tidak ada jalur evolusi lebih lanjut."
        },
        rein: {
    ...
    misc: {
        ...
        donate: {
            desc: "Mendukung Milky Interactive lewat donasi QRIS.",
            caption: "*# Donate Us*\n\nKlik di bawah ini untuk mengarahkan kamu ke page QRIS. Terima kasih telah donasi untuk Milky Interactive!",
            btn: "Buka Halaman QRIS"
        },
        report: {
